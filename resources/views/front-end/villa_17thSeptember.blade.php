...
<body>
 ...
 <div class="container width_fit_div">
...
@foreach($images as $image)
    @php
    $gallery_path = $image['image_path'];
    @endphp
<div class="mySlides">
    <div class="numbertext">{{ $loop->index+1  }} / {{ 6 }}</div>
    <img src="{{ asset('front-end/'.$gallery_path) }}" alt=" " class="img-responsive fit_img_villa" />
  </div>
@endforeach
...
<div id="slideshow" class="fullscreen"> 
    ...
    <div id="" data-img-id="" class="img-wrapper" style="background-image: url('front-end/images/{{ $img['image_path'] }}')"></div>
...
<ul class="thumbs">
@foreach($images as $img)
<li data-thumb-id="" class="thumb" style="background-image: url('front-end/images/{{ $img['image_path'] }}')"></li>
@endforeach
