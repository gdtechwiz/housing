				...
				<div class="activity_box">
					...
					<div class="scrollbar" id="style-1">
						<div class="activity-row">
							<div class="col-xs-3 activity-img"><img src="{{ asset('admin/images/1.jpg') }}" class="img-responsive" alt=""/></div>
						...
						<div class="activity-row">
							<div class="col-xs-3 activity-img"><img src="{{ asset('admin/images/4.jpg') }}" class="img-responsive" alt=""/></div>
							<div class="col-xs-7 activity-desc">
						...
						<div class="activity-row">
							<div class="col-xs-3 activity-img"><img src="{{ asset('admin/images/3.jpg') }}" class="img-responsive" alt=""/></div>
							<div class="col-xs-7 activity-desc">
						...
						<div class="activity-row">
							<div class="col-xs-3 activity-img"><img src="{{ asset('admin/images/2.jpg') }}" class="img-responsive" alt=""/></div>
							<div class="col-xs-7 activity-desc">
