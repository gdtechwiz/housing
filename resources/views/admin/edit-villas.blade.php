                            ...
                            {{ csrf_field() }}
                                ...
                                <div class="form-group">
								 ...
								 <div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="dynamic_villa_cost" placeholder="Dynamic Villa Cost(For X no of days)" value="{{ $villas->dynamic_villa_cost }}" name="dynamic_villa_cost">
									</div>
									<div class="col-sm-2">
										<p class="help-block"></p>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="dynamic_villa_ppl" placeholder="Dynamic Villa People(For X no of cost)" value="{{ $villas->dynamic_villa_ppl }}" name="dynamic_villa_ppl">
									</div>
									<div class="col-sm-2">
										<p class="help-block"></p>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="maximum_ppl_allowed" placeholder="Maximum People Allowed" value="{{ $villas->maximum_ppl_allowed }}" name="maximum_ppl_allowed">
									</div>
									<div class="col-sm-2">
										<p class="help-block"></p>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="children_rate" placeholder="Children's Rate" value="{{ $villas->children_rate }}" name="children_rate">
									</div>
									<div class="col-sm-2">
										<p class="help-block"></p>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="infant_rate" placeholder="Infant's Rate" value="{{ $villas->infants_rate }}" name="infants_rate">
									</div>
									<div class="col-sm-2">
										<p class="help-block"></p>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="extra_person_cost" placeholder="Extra Person Cost(Per Night)" value="{{ $villas->extra_person_cost }}" name="extra_person_cost">
									</div>
									<div class="col-sm-2">
										<p class="help-block"></p>
									</div>
