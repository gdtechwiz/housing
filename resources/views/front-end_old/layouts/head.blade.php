...
<link type="text/css" rel="stylesheet" href="{{ asset('front-end/css/JFFormStyle-1.css') }}" />
<link type="text/css" rel="stylesheet" href="{{ asset('front-end/css/global.css') }}" />
<!-- js -->
...
<!--pop-up-->
<script src="{{ asset('front-end/js/menu_jquery.js') }}"></script>
<!--//pop-up-->	
